...
namespace core
{
	...
	namespace archive
	{
		...
		public:
			...
			virtual void serialize(coll_helper &_coll) const override;
			virtual bool unserialize(const coll_helper &_coll) override;

			virtual void serialize(core::tools::tlvpack &_pack) const override;
		...
		public:
			...
			void serialize(icollection* _collection, const std::string &_internal_id, const bool _is_outgoing) const;
		...
		public:
			...
			void serialize(icollection* _collection, const bool _is_outgoing) const;

			void serialize(tools::tlvpack& _pack) const;
			std::string getSenderId() const
			{
				return sender_aimid_;
			}
		...
		private:
			...
			void serialize_chat_modifications(coll_helper &_coll) const;

			void serialize_chat_modifications(tools::tlvpack &_pack) const;

			void serialize_mchat_members(coll_helper &_coll) const;

			void serialize_mchat_members(tools::tlvpack &_pack) const;
			...
			struct
			{
				...
				std::set<std::string> members_friendly_;
			} mchat_;
